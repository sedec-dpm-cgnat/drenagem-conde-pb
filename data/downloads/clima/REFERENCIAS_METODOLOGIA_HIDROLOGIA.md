...
4. **EPA SWMM.** Os arquivos preliminares usam a estrutura do SWMM, infiltração `CURVE_NUMBER`, `Rain Gage`, séries de 5 minutos e roteamento dinâmico. A página oficial, o [User’s Manual 5.2](https://www.epa.gov/system/files/documents/2022-04/swmm-users-manual-version-5.2.pdf), o [Reference Manual Volume I - Hydrology](https://nepis.epa.gov/Exe/ZyPURL.cgi?Dockey=P100NYRA.TXT) e o [Reference Manual Volume II - Hydraulics](https://nepis.epa.gov/Exe/ZyPURL.cgi?Dockey=P100S9AS.txt) descrevem a cadeia hidrológica e hidráulica adotada.
...
10. **NASA NEX-GDDP-CMIP6.** NEX significa NASA Earth Exchange; GDDP, Global Daily Downscaled Projections; CMIP6, Coupled Model Intercomparison Project Phase 6. A coleção reúne projeções diárias de modelos globais, com cenários SSP e downscaling BCSD. A base em grade orienta a análise de sensibilidade climática diária por GCM, cenário e horizonte. [Página oficial da coleção](https://www.nccs.nasa.gov/data-collections/nex-gddp-cmip6/) e [nota técnica v2](https://www.nccs.nasa.gov/wp-content/uploads/2025/06/NEX-GDDP-CMIP6-v2-Tech_Note.pdf).

11. **Thrasher, B.; Wang, W.; Michaelis, A. et al. (2022).** *NASA Global Daily Downscaled Projections, CMIP6*. *Scientific Data*, 9, 262. [DOI](https://doi.org/10.1038/s41597-022-01393-4). Descreve a coleção NEX-GDDP-CMIP6 e sua organização.
12. **Thrasher, B.; Maurer, E. P.; McKellar, C.; Duffy, P. B. (2012).** *Technical Note: Bias correcting climate model simulated daily temperature extremes with quantile mapping*. *Hydrology and Earth System Sciences*, 16(9), 3309-3314. [DOI](https://doi.org/10.5194/hess-16-3309-2012). Fundamenta o princípio de correção por mapeamento de quantis e não fornece parâmetros locais de Conde.
13. **Rossman, L. A.; Huber, W. C. (2016).** *Storm Water Management Model Reference Manual, Volume I - Hydrology (Revised)*. EPA/600/R-15/162A. [Manual](https://nepis.epa.gov/Exe/ZyPURL.cgi?Dockey=P100NYRA.TXT). Referência da representação de subáreas, reservatório não linear, infiltração, CN e escoamento no SWMM.
14. **Rossman, L. A. (2017).** *Storm Water Management Model Reference Manual, Volume II - Hydraulics*. EPA/600/R-17/111. [Manual](https://nepis.epa.gov/Exe/ZyPURL.cgi?Dockey=P100S9AS.txt). Referência do roteamento, das equações de Saint-Venant, da onda dinâmica, do remanso, da sobrecarga e do refluxo.
15. **Eyring, V. et al. (2016).** *Overview of the Coupled Model Intercomparison Project Phase 6 (CMIP6) experimental design and organization*. *Geoscientific Model Development*, 9, 1937-1958. [DOI](https://doi.org/10.5194/gmd-9-1937-2016). Referência do desenho experimental e dos cenários do CMIP6.
...
Os valores calculados nesta concepção são adequados para comparar alternativas, localizar gargalos e estruturar metas do Plano de Trabalho. Eles não devem ser apresentados como especificações executivas enquanto as fontes primárias e as verificações acima não estiverem anexadas e auditadas. O NEX-GDDP-CMIP6 não é uma IDF pronta: o recorte local contém máximas diárias anuais, enquanto o SWMM precisa de uma série temporal de chuva e de parâmetros hidrológicos e hidráulicos compatíveis com a escala urbana.
